...
internal static class ConfigurationExtensions
{
    ...
    public static MemoryBuilder WithTextEmbeddingGeneration(this MemoryBuilder memoryBuilder, string? connectionString)
    {
        var connectionStringBuilder = new DbConnectionStringBuilder();
        connectionStringBuilder.ConnectionString = connectionString;
            ...
            case "AzureOpenAI":
                {
                    ...
                    memoryBuilder.WithTextEmbeddingGeneration(new AzureOpenAITextEmbeddingGenerationService(textEmbeddingsDeploymentName, endpoint: endpoint, apiKey: key));
            ...
            case "OpenAI":
                {
                    ...
                    memoryBuilder.WithOpenAITextEmbeddingGeneration(modelId: textEmbeddingsModelId, apiKey: apiKey);
    ...
    public static ITextEmbeddingGenerationService CreateAzureOpenAITextEmbeddingGenerationService(string? connectionString)
    {
        var connectionStringBuilder = new DbConnectionStringBuilder();
        connectionStringBuilder.ConnectionString = connectionString;
        ...
        return new AzureOpenAITextEmbeddingGenerationService(textEmbeddingsDeploymentName, endpoint: endpoint, apiKey: key);
    }

    public static ITextEmbeddingGenerationService CreateOpenAITextEmbeddingGenerationService(string? connectionString)
    {
        var connectionStringBuilder = new DbConnectionStringBuilder();
        connectionStringBuilder.ConnectionString = connectionString;
        ...
        return new OpenAITextEmbeddingGenerationService(modelId: textEmbeddingsModelId, apiKey: apiKey);
    }
