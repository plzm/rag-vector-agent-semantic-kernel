...
public static class TravelAgentChatHelper
{
  ...
  /// </summary>
  public static async Task TravelAgentGroupChatSequential(Kernel kernel)
  {
    ...
    string TravelAgencyAgentInstructions = """
            ...
            You are a Travel Agency Agent, and your goal is to ASK for flight and hotel options and to select the best travel options for the user's trip based in the user request
            ...
            After you select and justify the options, you should approve the request by just responding "approve and ready to book"
    ...
    string BookingAgentInstructions = $$$"""
            ...
            you receive the approved  flight information and approved hotel information and book the flight and hotel.
            You only participate when you received approved request from Travel Agency Agent that includes the specific flight and hotel to book.
            You respond '{{{terminationKey}}}' only.
        """;
    ...
    ChatCompletionAgent BookingAgent = CreateBasicAgent("BookingAgent", kernel, BookingAgentInstructions, "Booking Agent, you book the flight and hotel when you receive 'Approve and ready to book!' confirmation");
