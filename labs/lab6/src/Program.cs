...
class Program
{
  ...
  static async Task Main(string[] args)
  {
    ...
    {
      case "1":
        await Call_CityPoetAgentBasic(theAgentKernel);
        break;
      case "2":
      ...
      case "3":
        ...
        break;
      case "4":
        await TravelAgentChatHelper.TravelAgentGroupChatSequential(theAgentKernel);
        break;
      case "5":
  ...
  static ChatCompletionAgent CreateAgentCityPoetBasic(Kernel AgentKernel)
  {
    ...
    ChatCompletionAgent agent =
        new()
        {
          ...
          Instructions =
                """
                You are an agent designed to write poems based on a suject and another poet tone.
